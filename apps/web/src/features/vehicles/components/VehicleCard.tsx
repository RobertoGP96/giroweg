...
import type { VehicleSummary } from "../hooks/useVehicles";
...
/** One vehicle in the list: type, name, plate, current odometer and sync state. */
export function VehicleCard({ summary }: VehicleCardProps) {
  ...
  return (
    <Link href={`/vehicles/${vehicle.id}`} className="rounded-lg outline-none focus-visible:ring-2 focus-visible:ring-lime">
